...
echo -e "\033[0m"
sleep 2
sudo apt-get install -y build-essential kernel-package libncurses5-dev bzip2 fakeroot git git-core filezilla minitube audacity soundconverter easytag arista dconf-tools transmission trimage guvcview meld blender gparted screenkey dkms empathy shotwell aptitude hardinfo gufw brasero guake xchat chromium-browser synaptic htop nmon dstat xbmc gnome-sushi unoconv unrar gstreamer0.10-plugins-bad cmatrix libaa-bin bb conky conky-all git-core
